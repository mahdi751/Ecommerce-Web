...
class ShippingController extends Controller
{
    ...
    public function index()
    {
        ...
        $shipping=Shipping::orderBy('id','DESC')->where('store_id',$storeId)->paginate(10);
        return view('Sellers.shipping.index')->with('shippings',$shipping);
    }
    ...
    {
        return view('Sellers.shipping.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('Sellers.shipping.edit')->with('shipping',$shipping);
    }
