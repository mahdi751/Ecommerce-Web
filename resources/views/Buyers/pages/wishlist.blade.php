							...
							@if(Helper::getAllProductFromWishlist())
								@foreach(Helper::getAllProductFromWishlist() as $key=>$wishlist)
									<tr>
										...
										<td class="total-amount" data-title="Total"><span>{{$selectedCurrencySign}}{{number_format(Helper::getAmountConverted($selectedCurrency, $wishlist['amount']))}}</span></td>
										<td><a href="{{route('add-to-cart',$wishlist->product['slug'])}}">Add To Cart</a></td>
