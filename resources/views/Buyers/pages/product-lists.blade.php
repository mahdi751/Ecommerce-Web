                            ...
                            <div class="single-product">
                              <div class="product-img">
                                <a href="{{ route('product-detail', $product->slug) }}">
                                  ...
                                  @endphp
                                  <img class="default-img product-image"src="{{ $photo[0] }}"
                                    alt="{{ $photo[0] }}">
                                  <img class="hover-img product-image" src="{{ $photo[0] }}"
                                    alt="{{ $photo[0] }}">
                                </a>
                            ...
                            <div class="list-content">
                              <div class="product-content">
                                <div class="product-price">
                                  @php
                                    $after_discount =
                                        Helper::getAmountConverted($selectedCurrency, $product->price) -
                                        (Helper::getAmountConverted($selectedCurrency, $product->price) *
                                            $product->discount) /
                                            100;
                                  @endphp
                                  <span>{{ $selectedCurrencySign }}{{ number_format($after_discount, 2) }}</span>
                                  <del>{{ $selectedCurrencySign }}{{ number_format(Helper::getAmountConverted($selectedCurrency, $product->price), 2) }}</del>
                                </div>
                                <h3 class="title"><a
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                  <div class="quickview-content">
                    ...
                    @php
                      $after_discount =
                          Helper::getAmountConverted($selectedCurrency, $product->price) -
                          (Helper::getAmountConverted($selectedCurrency, $product->price) * $product->discount) / 100;
                    @endphp
                    <h3><small><del
                          class="text-muted">{{ $selectedCurrencySign }}{{ number_format($product->price, 2) }}</del></small>
                      {{ $selectedCurrencySign }}{{ number_format($after_discount, 2) }} </h3>
