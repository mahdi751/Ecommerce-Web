            ...
            <tbody>
              ...
              @foreach ($events as $event)
                ...
                <tr>
                  ...
                  <td>
                    @if ($event->photo)
                      <img src="{{ $event->photo }}" class="img-fluid" style="max-width:80px" alt="{{ $event->photo }}">
                    @else
                  ...
                  <td>
                    <a href="{{ route('event.edit', $event->id) }}" class="btn btn-primary btn-sm float-left mr-1"
                    ...
                    @if ($event->status == 'active')
                      <form method="POST" action="{{ route('end.event', [$event->id]) }}">
                        @csrf
                        <button type="submit" class="btn btn-warning btn-sm" style="height:30px; border-radius:10%"
                          data-toggle="tooltip" data-placement="bottom" title="End Event">End</button>
                      </form>
                    @endif
                  </td>
                </tr>
